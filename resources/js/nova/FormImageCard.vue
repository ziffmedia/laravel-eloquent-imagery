<template>
  <div class="px-2 py-2">
    <img
      ...
      @click.prevent="openPreviewImageModal"
    />
    ...
    <div v-show="!isReadonly">
      ...
      <div class="flex">
        <div class="flex-1 text-center cursor-pointer" @click="$refs['replaceImageFileInput'].click()">
      ...
      <!--  <form-metadata-modal :isReadonly="isReadonly" v-bind:image.sync="image" @modalClose="handleClickaway"></form-metadata-modal>-->
      <!--</portal>-->
    </div>
  </div>
</template>
