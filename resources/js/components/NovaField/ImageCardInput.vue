<template>
  <div class="flex px-6 py-4 border border-70">
    <div>
      ...
      <div class="flex">
        ...
        <div class="flex-1 text-center" v-on:click.prevent="$emit('remove-image', image)">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            ...
            <div class="w-2/3 bg-white m-auto select-text" style="min-height: 12em">
              <div class="w-full m-2 p-8">
                ...
                <div class="flex px-3" v-for="(metadata, index) in image.metadata">
                  <input type="text" class="w-1/3 text-xs form-control form-input form-input-bordered" v-model="image.metadata[index].key" />
                  <input type="text" class="w-full text-xs form-control form-input form-input-bordered" v-model="image.metadata[index].value" />
                  <span  v-on:click.prevent="removeMetadata(image, index)">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                ...
                <div class="float-right">
                  <span v-on:click.prevent="addMetadata(image)">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
