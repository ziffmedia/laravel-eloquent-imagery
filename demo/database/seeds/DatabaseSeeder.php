    ...
    public function singleImageExamples()
    {
        tap(new SingleImageExample, function ($model) {
            ...
            $model->variations = [
                ...
                'Convert to PNG and fit Limit to 300 in width, 200 in height' => 'fit_limit|size_300x200|pngconvert', //this one should result in just fit_limit, because source file is already png
            ];
        ...
        tap(new SingleImageExample, function ($model) {
            ...
            $model->variations = [
                ...
                'Convert to PNG and fit Limit to 600 in width, 300 in height' => 'fit_limit|size_600x300|pngconvert',
            ];
